...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: Aakriti Singh", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr :0111AL201001", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nMobile :8235754264\n\n\n\n", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="Guided by : Dr Kiran Pandey", font='Arial 15 bold', bg='light blue', fg='red').pack()
